            ...
            if file.endswith(".py"):
                ...
                with open(os.path.join(root, file), "r") as f:
                    ...
                    def document_data(i, name, line, other_docs, parent_string=""):
                        ...
                        future_reference = f"[{class_declaration.strip()}](./../{file_path}#L{i + 1}) \n\n"
                        ...
                        other_docs += f"<details><summary>Documentation</summary><br>{future_reference + new_documentation}</details>\n\n"
                        other_docs += "====================\n\n"
