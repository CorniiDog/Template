...
if output_instructions:
    ...
    with open("README.md", "w") as f:
        ...
        if project_name == "Template":
            ...
            f.write(f"- <service_name> \n\nis the name of the service. Replace <service_name> with the name of the service (ex. {service_name}).\n\n")
            turn_to_readme = turn_to_readme.replace(service_name, "<service_name>")

            # Replace the service path with <service_path>
            f.write(f"- <service_path> \n\nis the path to the service file. Replace <service_path> with the path to the service file (ex. {service_path}).\n\n")
            turn_to_readme = turn_to_readme.replace(service_path, "<service_path>")

            # Replace the service moved path with <service_moved_path>
            f.write(f"- <service_moved_path> \n\nis the path to the service file after it has been moved. Replace <service_moved_path> with the path to the service file after it has been moved (ex. {service_moved_path}).\n\n")
            ...
            f.write(f"- <requirements_file> \n\nis the path to the requirements file. Replace <requirements_file> with the path to the requirements file (ex. {requirements_file}).\n\n")
            ...
            f.write(f"- <conda_requirements_file> \n\nis the path to the conda requirements file. Replace <conda_requirements_file> with the path to the conda requirements file (ex. {conda_requirements_file}).\n\n")
            ...
            f.write(f"- <conda_forge_requirements_file> \n\nis the path to the conda-forge requirements file. Replace <conda_forge_requirements_file> with the path to the conda-forge requirements file (ex. {conda_forge_requirements_file}).\n\n")
