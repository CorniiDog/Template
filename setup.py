...
if output_instructions:
    ...
    turn_additional_to_readme = ""
    for line in additional_instructions.split("\n"):
        if line.startswith("-=["):
            # Make it a header with hash
            turn_additional_to_readme += f"## {line[3:-3]}\n" + "\n"
        else:
            turn_additional_to_readme += line + "\n" + "\n"
    ...
    with open("README.md", "w") as f:
        ...
        if project_name == "Template":
            f.write(turn_additional_to_readme)

        f.write("NOTE: This file is automatically generated. To regenerate this file, run \"python3 setup.py\".\n\n")
